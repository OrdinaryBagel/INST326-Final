...
def functions(func):
    ...
    if func == 1:
        ...
        gp = int(input(f"Please enter the number of games played by the {name}: "))
        pts = int(input(f"Please enter the average number of points per game scored by the {name}: "))
        off_rebounds = int(input(f"Please enter the average number of offensive rebounds per game earned by the {name}: "))
        def_rebounds = int(input(f"Please enter the average number of defensive rebounds per game earned by the {name}: "))
        ast = int(input(f"Please enter the average number of assists per game earned by the {name}: "))
        stl = int(input(f"Please enter the average number of steals per game earned by the {name}: "))
        blk = int(input(f"Please enter the average number of blocks per game earned by the {name}: "))
        to = int(input(f"Please enter the average number of turnovers per game earned by the {name}: "))
        pf = int(input(f"Please enter the average number of fouls per game earned by the {name}: "))
